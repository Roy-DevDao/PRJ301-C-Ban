...
<html>
    ...
    <head>
        ...
        <title> Trang chủ - FoodSystem </title>
                    ...
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav  mx-auto ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="./aboutcontroller">Information</a>
                                </li>
                                <%if (imagepath == null) {%>
                                <li class="nav-item">
                                    <a class="nav-link" href="./registercontroller">Sign Up</a>
                                </li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-lg-6 ">
                                                    <div class="detail-box">
                                                        <h1>
                                                            Thích Thì Vào Đây Mà Ăn
                                                        </h1>
                                                        <p>
                                                            Thực đơn quán vô cùng phong phú! LƯỚT XUỐNG MÀ XEM
                                                        </p>
                                                        <div class="btn-box">
